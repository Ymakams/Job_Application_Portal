...
<div id="page" class="box">
    <div id="page-in" class="box">
        ...
        <!-- Content -->
        <div id="content" class="float-left"> <!-- Float content to the left -->
            ...
            <!-- Article -->
            <div class="article">
                <h2><span><a href="#">Welcome To Job Portal System by  Amy</a></span></h2>
                <h3><marquee>Welcome To Job Portal System by  Amy</marquee></h3>
                ...
                <p align="right"> <img src="design/banner-4.jpg" alt="" style="max-width: 100%; height: auto/></p>
...
<div id="contact-us"> <!-- Contact Us content goes here as the footer -->
